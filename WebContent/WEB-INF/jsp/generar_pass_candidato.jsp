...
<div class="container-fluid">
			 <h1>Generar Password candidato</h1>
			 ...
			 <form action="ControladorPassCandidato" method="post">
 
    
    <label for="nombre">Generar password a Candidato:</label>
    
   <select class="form-control" id="estado" name="candidato_id" required="">
   		 <c:forEach items="${candidatos}" var="candidato">
       <option value="${candidato.id}">${candidato.nombre_apel}</option>
        </c:forEach>
      </select>
   ...
   <br>
    ...
    <label for="edad">User:</label>
    <input type="text" class="form-control" id="user" name="User" required="">
  
   <br />
    
    <label for="edad">Nuevo Password:</label>
    <input type="password" class="form-control" id="password1" name="NuevoPass" required="">
  
   <br />
      <label for="edad">Repita Nuevo Password:</label>
    <input type="password" class="form-control" id="password2" name="NuevoPassRep" required="">
      <br>
